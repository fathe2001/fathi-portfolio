...
const mockProfile: Profile = {
  ...
  summary: 'Computer Science graduate from the Hebrew University of Jerusalem with hands-on production engineering experience at Dynamic Yield.',
...
describe('About', () => {
  ...
  it('renders all highlights as list items (Req 3.2)', () => {
    ...
    expect(
      screen.getByText(/Tutored Python to 30\+ university students/i),
    ).toBeInTheDocument();
    expect(
